...
This file gathers demographics data for epilepsy patients from Haneef 2022.
...
FROM SCS_EEGUtil.EEG.rnRehmanEpilepsy coh
...
DROP TABLE IF EXISTS SCS_EEGUtil.EEG.rnRehmanDemographics;
SELECT coh.PatientICN,
    birth.BirthDate,
    death.DeathDate,
    sex.Sex,
    race.Race,
    ethnicity.Ethnicity
INTO SCS_EEGUtil.EEG.rnRehmanDemographics
FROM SCS_EEGUtil.EEG.rnRehmanEpilepsy coh
