...
DROP TABLE IF EXISTS
    ORD_Haneef_202402056D.Dflt.rnCohort3
;
CREATE TABLE 
    ORD_Haneef_202402056D.Dflt.rnCohort3 (
...
DROP TABLE IF EXISTS
    ORD_Haneef_202402056D.Dflt.rnTBI3a
;
CREATE TABLE 
    ORD_Haneef_202402056D.Dflt.rnTBI3a (
        PatientICN VARCHAR(10) PRIMARY KEY,
        TBIDate DATE,
        TBIClass1 VARCHAR(20),
...
DROP TABLE IF EXISTS
    ORD_Haneef_202402056D.Dflt.rnTBI3b
;
CREATE TABLE 
    ORD_Haneef_202402056D.Dflt.rnTBI3b (
        PatientICN VARCHAR(10) PRIMARY KEY,
...
FROM
    ...
    INNER JOIN
    ORD_Haneef_202402056D.Dflt.rnCohort3 coh
        ON
        elix.PatientICN = coh.PatientICN
;

DROP TABLE IF EXISTS
    ORD_Haneef_202402056D.Dflt.rnECI3
;
CREATE TABLE 
    ORD_Haneef_202402056D.Dflt.rnECI3 (
        PatientICN VARCHAR(10) PRIMARY KEY,
...
DROP TABLE IF EXISTS
    ORD_Haneef_202402056D.Dflt.rnESI3
;
CREATE TABLE 
    ORD_Haneef_202402056D.Dflt.rnESI3 (
        PatientICN VARCHAR(10) PRIMARY KEY,
...
DROP TABLE IF EXISTS
    ORD_Haneef_202402056D.Dflt.rnCohortInfo3
;
CREATE TABLE 
    ORD_Haneef_202402056D.Dflt.rnCohortInfo3 (
        PatientICN VARCHAR(10) PRIMARY KEY,
...
SELECT
    ...
    tbib.TBIDate AS TBIHistoryDate,
    
    tbia.TBIDate AS TBIDate,
    tbia.TBIClass1 AS TBIClass,
    tbia.OccurrenceType AS TBIOccurrenceType
FROM
    ORD_Haneef_202402056D.Dflt.rnCohort3 coh
    INNER JOIN
    ...
    INNER JOIN
    ORD_Haneef_202402056D.Dflt.rnECI3 eci
        ON
        coh.PatientICN = eci.PatientICN
    INNER JOIN
    ORD_Haneef_202402056D.Dflt.rnESI3 esi
        ON
    ...
    LEFT JOIN
    ORD_Haneef_202402056D.Dflt.rnTBI3b tbib
        ON
        coh.PatientICN = tbib.PatientICN
    LEFT JOIN
    ORD_Haneef_202402056D.Dflt.rnTBI3a tbia
        ON
        coh.PatientICN = tbia.PatientICN
;
