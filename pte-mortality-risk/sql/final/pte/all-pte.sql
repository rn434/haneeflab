...
code preceding their epilepsy diagnosis.
...
DROP TABLE IF EXISTS #TBIKarlanderCategories;
SELECT
    PatientICN,
...
DROP TABLE IF EXISTS #TBIArmedCategories;
SELECT
    PatientICN,
...
DROP TABLE IF EXISTS ORD_Haneef_202402056D.Dflt.rnPTEAllFinal;
CREATE TABLE ORD_Haneef_202402056D.Dflt.rnPTEAllFinal (
    PatientICN VARCHAR(10) PRIMARY KEY,
...
INSERT INTO ORD_Haneef_202402056D.Dflt.rnPTEAllFinal (
    PatientICN,
...
DELETE FROM ORD_Haneef_202402056D.Dflt.rnPTEAllFinal
WHERE
...
from ORD_Haneef_202402056D.Dflt.rnPTEAllFinal
