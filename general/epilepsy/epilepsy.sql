...
WHERE fill.DaysSupply >= 30
    AND NOT (asm.DrugNameWithoutDose LIKE 'gabapentin'
        OR asm.DrugNameWithoutDose LIKE 'pregabalin');
...
DROP TABLE IF EXISTS SCS_EEGUtil.EEG.rnEpilepsy;
...
INTO SCS_EEGUtil.EEG.rnEpilepsy
...
SELECT COUNT(*) AS AllEpilepsyCount FROM SCS_EEGUtil.EEG.rnEpilepsy;
